...
print("Removing duplicated row")
online_trans_cleaned_wo_dupp = identify_and_remove_duplicated_data(online_trans_cleaned)

# next step, load the deduped data to s3
print("Loading data to S3")
s3_bucket = "waia-data-dump"
# the key should include your initial
key = "bootcamp2/etl/am_online_trans_cleaned.csv"

df_to_s3(online_trans_cleaned_wo_dupp, key, s3_bucket, aws_access_key_id, aws_secret_access_key_id)
